...
Page({
  ...
  data: {
    ...
    registingCompetitions: [{ name: "周末五分钟快棋赛100格巴西", constitution: "", image: "/static/competition/cover.jpg" }, { name: "周末快棋赛100格俄罗斯", constitution: "云顶工坊", image: "/static/competition/cover.jpg" },{ name: "周末快棋赛100格俄罗斯", constitution: "云顶工坊", image: "/static/competition/cover.jpg" }],
...
//记录目前页数
  ...
  GoToEdCompetition: function(){
    ...
    wx.navigateTo({
      url: '../edcompetition/edcompetition',
    })
  },
  ...
  GoToCompetitionInfo: function(e){
    ...
    wx.navigateTo({
      url: '/pages/competition/competitioninfo/competitioninfo?id=' + e.currentTarget.dataset.competitionid,
    });
